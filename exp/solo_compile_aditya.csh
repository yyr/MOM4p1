...
set echo
set platform      = intel_aditya          # A unique identifier for your platform
...
#
set type          = mom4p1_solo                       # Type of the experiment
...
if($MPI) set cppDefs  = ( "-Duse_netCDF  -Duse_netCDF3 -Duse_libMPI" )
